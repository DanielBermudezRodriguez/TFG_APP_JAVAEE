  ...
  private void init() {
   ...
   /* try {
      ...
      if (exists == null) {
        ...
        // Provincias
        Provincia provincia = new Provincia("Gerona");
        pais.addProvincias(provincia);
        provincia.setPais(pais);
        
        Provincia provincia2 = new Provincia("Tarragona");
        pais.addProvincias(provincia2);
        provincia2.setPais(pais);
        
        // Municipios Gerona
        Municipio municipio = new Municipio("Lloret de Mar"); 
        provincia.addMunicipios(municipio);
        municipio.setProvincia(provincia);
        
        Municipio municipio2 = new Municipio("Blanes"); 
        provincia.addMunicipios(municipio2);
        municipio2.setProvincia(provincia);
        
        Municipio municipio3 = new Municipio("Tossa de Mar"); 
        provincia.addMunicipios(municipio3);
        municipio3.setProvincia(provincia);
        
        // Municipios Tarragona
        Municipio municipio4 = new Municipio("Alcanar"); 
        provincia2.addMunicipios(municipio4);
        municipio4.setProvincia(provincia2);
        
        Municipio municipio5 = new Municipio("Blancafort"); 
        provincia2.addMunicipios(municipio5);
        municipio5.setProvincia(provincia2);
        
        Municipio municipio6 = new Municipio("Calafell"); 
        provincia2.addMunicipios(municipio6);
        municipio6.setProvincia(provincia2);
