...
/**
 * Esta clase define la comparación a realizar entre distintos eventos
 * deportivos para ser ordenados en una lista.
 * 
...
public class EventosComparator implements Comparator<Evento> {
	 ...
	 * Se realiza la comparación entre dos eventos deportivos. En caso de que tengan
	 * el mismo estado (Abierto,Completo,Finalizado o Suspendido), se comparan por
	 * fecha de celebración del evento. En caso de un evento esté en un estado final
	 * (Finalizado o suspendido) y el otro en un estado no final (Abierto o
	 * Completo) se devuelve como mayor el evento en fase no final.
	 * 
	 * @param e1
	 *            Evento deportivo a comparar.
	 * @param e2
	 *            Evento deportivo a comparar.
	 * @return Devuelve 1 si el evento e1 es mayor, -1 si el evento e2 es mayor o 0
	 *         si son iguales.
	 */
	@Override
	...
	/**
	 * Método encargado de indicar si el estado de un evento corresponde a un estado
	 * final. Indica si el estado de un evento deportivo es finalizado o suspendido.
	 * 
	 * @param idEstado
	 *            Identificador del estado de un evento deportivo.
